...
import getReviews from '@/api/DemandPlannerMonthly/getReviews';
import addReview from '@/api/DemandPlannerMonthly/addReview';
  ...
  <div class="tw-w-full tw-h-full tw-px-3 tw-py-4">
    <div class="tw-flex tw-flex-col tw-py-2">
      ...
      <div class="tw-flex tw-gap-x-4 desktop:tw-gap-x-3 tw-items-center tw-w-full">
        <p class="tw-text-lg desktop:tw-text-sm small-laptop:tw-text-sm tw-font-medium">{{ periodLabel }}</p>
        <div
    ...
    <div
      :class="`tw-grid tw-py-2 small-laptop:tw-py-1 ${
