...
<template>
  <div class="tw-flex tw-gap-x-4 tw-items-center tw-w-full tw-py-2">
    <p
      class="tw-font-medium tw-text-2xl desktop:tw-text-xl small-laptop:tw-text-lg"
    >
      More details for {{ periodLabel }}
    </p>
    <div class="tw-bg-brand-gray-4 tw-rounded" v-if="formattedHorizon">
      <p class="tw-p-1 tw-text-sm desktop:tw-text-xs small-laptop:tw-text-xs">
        Future {{ formattedHorizon }} months
      </p>
    </div>
  </div>
  <div class="tw-py-3 tw-w-full">
    ...
    >
      <div
        class="tw-col-span-2 desktop:tw-col-span-4 small-laptop:tw-col-span-4"
      >
        <ChartKeyDemandDrivers
      ...
      <div
        class="tw-col-span-1 desktop:tw-col-span-2 small-laptop:tw-col-span-2"
      >
        <ChartPYandImpliedGrowth
