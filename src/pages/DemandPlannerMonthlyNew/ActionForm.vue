...
<template>
  <v-dialog :model-value="actionFormIsShown" width="auto" persistent>
    <div class="tw-w-[80vw] tw-h-[80vh] tw-overflow-auto tw-bg-white tw-p-3">
      <div
        class="tw-w-full tw-h-full tw-min-w-[800px] tw-min-h-[450px] tw-flex tw-flex-col"
      >
        <h1 class="tw-text-lg tw-font-bold tw-pb-3">
          Recommended Action - {{ getStatus(variance) }} Status
        </h1>
        <div class="tw-grid tw-grid-cols-2 tw-grow">
          <div
          ...
          >
            <div
              class="tw-w-full tw-h-3/5 small-laptop:tw-h-2/4 tw-overflow-auto tw-mb-4"
            >
